...
public class Centralmoment {
    ...
    public static void main(String[] args) throws IOException {
        String path = "C:\\Users\\G_LEI\\Desktop\\images\\abc_2602.jpg";
        FileInputStream fi = new FileInputStream(new File(path));
        BufferedImage img = ImageIO.read(fi);
        double[] hsv = Centralmoment.toHSV(img);
        String path2 = "C:\\Users\\G_LEI\\Desktop\\images\\abc_4505.jpg";
        FileInputStream fi2 = new FileInputStream(new File(path2));
        BufferedImage img2 = ImageIO.read(fi2);
        double[] hsv2 = Centralmoment.toHSV(img2);
        double sss = Centralmoment.Metri(hsv,hsv2);
        System.out.println("sss====="+sss);
        System.out.println("length  -- "+hsv.length);
        for(int i = 0;i<hsv.length;i++){
            System.out.println("--"+String.valueOf(i)+"=="+hsv[i]);
        }
    }
